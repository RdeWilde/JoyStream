...
var clientDaemon = new rpc.Daemon('localhost:3003', grpc.credentials.createInsecure());
var wallet = new rpc.Wallet('localhost:3003', grpc.credentials.createInsecure());
