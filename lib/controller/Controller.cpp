...
libtorrent::sha1_hash Controller::Torrent::Configuration::getInfoHash() const {
    return _infoHash;
}

std::string Controller::Torrent::Configuration::getName() const {
     return _name;
}

std::string Controller::Torrent::Configuration::getSavePath() const {
    return _savePath;
}

std::vector<char> Controller::Torrent::Configuration::getResumeData() const {
    return _resumeData;
}

quint64 Controller::Torrent::Configuration::getFlags() const {
    return _flags;
}

const libtorrent::torrent_info * Controller::Torrent::Configuration::getTorrentInfo() const {
    return _torrentInfo;
}
...
Controller::Torrent::Torrent(const libtorrent::sha1_hash & infoHash,
    ...
    ,_flags(flags)
    ,_torrentInfo(torrentInfo)
    ,_loadedTorrentPluginConfiguration(loadedTorrentPluginConfiguration)
    ,_event(event) {
}

libtorrent::sha1_hash Controller::Torrent::getInfoHash() const {
    return _infoHash;
}

std::string Controller::Torrent::getName() const {
     return _name;
}

std::string Controller::Torrent::getSavePath() const {
    return _savePath;
}

std::vector<char> Controller::Torrent::getResumeData() const {
    return _resumeData;
}

quint64 Controller::Torrent::getFlags() const {
    return _flags;
}

const libtorrent::torrent_info * Controller::Torrent::getTorrentInfo() const {
    return _torrentInfo;
}
...
void Controller::updateTorrentPluginConfiguration(const libtorrent::sha1_hash & infoHash, TorrentPlugin::Configuration * configuration) {
