...
namespace joystream {
  namespace addon {
    namespace protocol_session {
      ...
      v8::Local<v8::Object> ConnectionTCPEndpoint::NewInstance(const joystream::protocol_session::status::Connection<libtorrent::tcp::endpoint>& c) {
      ...
      NAN_METHOD(ConnectionTCPEndpoint::New) {
