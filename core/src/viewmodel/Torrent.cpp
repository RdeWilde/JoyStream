...
namespace joystream {
    ...
    namespace core {
        ...
        namespace viewmodel {
            ...
            /**
            Torrent::Torrent(SellerTorrentPluginViewModel * model)
                : _pluginInstalled(PluginInstalled::Seller)
                , _sellerTorrentPluginViewModel(model)
                , _buyerTorrentPluginViewModel(NULL) {
            }

            Torrent::Torrent(BuyerTorrentPluginViewModel * model)
            ...
            */
            ...
            void Torrent::addPeer(const libtorrent::tcp::endpoint & endPoint, const SellerPeerPlugin::Status & status) {
            ...
            void Torrent::addPeer(const libtorrent::tcp::endpoint & endPoint, const BuyerPeerPlugin::Status & status) {
            ...
            void Torrent::update(const libtorrent::torrent_status & status) {

                _status = status;
                emit torrentStatusChanged(status);
            }

            void Torrent::update(const SellerTorrentPlugin::Status & status) {
            ...
            void Torrent::update(const BuyerTorrentPlugin::Status & status) {
            ...
            /**
            void Torrent::pieceRead(const libtorrent::error_code & ec,
            ...
            */
            ...
            QString Torrent::savePath() const {
                return _savePath;
            }
            ...
            /**
            const libtorrent::torrent_info * Torrent::torrentInfo() const {
                return _torrentInfo;
            }
            */
            ...
            libtorrent::torrent_status Torrent::status() const {
                return _status;
            }

            SellerTorrentPluginViewModel * Torrent::sellerTorrentPlugin() const {
                return _sellerTorrentPluginViewModel;
            }

            BuyerTorrentPluginViewModel * Torrent::buyerTorrentPlugin() const {
                return _buyerTorrentPluginViewModel;
            }

            /**
            void Torrent::getRange(int start, int end) {
            ...
            void Torrent::getStart(int start) {
                getRange(start, start + _defaultRangeLength);
            }

            void Torrent::errorOccured(Stream::Error errorOccured) {
                qDebug() << "Torrent::errorOccured";
            }

            quint32 Torrent::numberOfClassicPeers() {

            }

            quint32 Torrent::numberOfObserverPeers() {

            }

            quint32 Torrent::numberOfSellerPeers() {

            }

            quint32 Torrent::numberOfBuyerPeers() {

            }

            quint64 Torrent::balance() {

            }
            */

            /**
            void Torrent::showExtensionDialog() {
