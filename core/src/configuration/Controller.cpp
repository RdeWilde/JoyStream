...
namespace configuration {
    ...
    */
    ...
    Controller::Controller(const char * fileName) {
        ...
        ControllerController::ControllerConfiguration(controllerConfigurationDictionaryEntry);
        */
    }
    ...
    /*
    void ControllerController::insertTorrentConfiguration(const TorrentConfiguration * torrentConfiguration) {
