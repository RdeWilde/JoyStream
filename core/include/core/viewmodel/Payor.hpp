...
#ifndef JOYSTREAM_CORE_VIEWMODEL_PAYOR_HPP
#define JOYSTREAM_CORE_VIEWMODEL_PAYOR_HPP
...
namespace viewmodel {
    ...
    public:
        ...
        // Constructor
        Payor(QObject * parent, const Payor::Status & status);
...
#endif // JOYSTREAM_CORE_VIEWMODEL_PAYOR_HPP
