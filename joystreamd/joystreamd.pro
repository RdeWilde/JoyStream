...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../daemon/release/ -ldaemon
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../daemon/debug/ -ldaemon
else:unix: LIBS += -L$$OUT_PWD/../daemon/ -ldaemon

INCLUDEPATH += $$PWD/../daemon/include
INCLUDEPATH += $$PWD/../daemon
DEPENDPATH += $$PWD/../daemon

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../daemon/release/libdaemon.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../daemon/debug/libdaemon.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../daemon/release/daemon.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../daemon/debug/daemon.lib
else:unix: PRE_TARGETDEPS += $$OUT_PWD/../daemon/libdaemon.a
