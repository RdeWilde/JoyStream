...
namespace alert {
    ...
    BuyerTorrentPluginConfiguration StartedBuyerTorrentPlugin::configuration() const {
        return _configuration;
    }

    void StartedBuyerTorrentPlugin::setConfiguration(const BuyerTorrentPluginConfiguration & configuration) {
        _configuration = configuration;
    }
    ...
    BuyerTorrentPluginStatus StartedBuyerTorrentPlugin::status() const {
        return _status;
    }

    void StartedBuyerTorrentPlugin::setStatus(const BuyerTorrentPluginStatus & status) {
        _status = status;
    }
