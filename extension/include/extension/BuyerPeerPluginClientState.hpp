...
#ifndef JOYSTREAM_EXTENSION_BUYER_PEER_PLUGIN_CLIENT_STATE_HPP
#define JOYSTREAM_EXTENSION_BUYER_PEER_PLUGIN_CLIENT_STATE_HPP

namespace joystream {
namespace extension {

    enum class BuyerPeerPluginClientState {
...
#endif // JOYSTREAM_EXTENSION_BUYER_PEER_PLUGIN_CLIENT_STATE_HPP
