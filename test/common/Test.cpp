...
void Test::BIP39()
{
    ...
    {
        uchar_vector entropy("00000000000000000000000000000000");
        Coin::Seed s = Coin::Seed::bip39(entropy, "TREZOR");
        QVERIFY(Coin::BIP39::toWordlist(entropy) == "abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about");
        QVERIFY(s.toHex().toStdString() == "c55257c360c07c72029aebc1b53c05ed0362ada38ead3e3e9efa3708e53495531f09a6987599d18264c1e1c92f2cf141630c7a3c4ab7c81b2f001698e7463b04");
    }
    {
        uchar_vector entropy("7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f");
        Coin::Seed s = Coin::Seed::bip39(entropy, "TREZOR");
        QVERIFY(Coin::BIP39::toWordlist(entropy) == "legal winner thank year wave sausage worth useful legal winner thank yellow");
        QVERIFY(s.toHex().toStdString() == "2e8905819b8723fe2c1d161860e5ee1830318dbf49a83bd451cfb8440c28bd6fa457fe1296106559a3c80937a1c1069be3a3a5bd381ee6260e8d9739fce1f607");
    }
    {
        uchar_vector entropy("80808080808080808080808080808080");
        Coin::Seed s = Coin::Seed::bip39(entropy, "TREZOR");
        QVERIFY(Coin::BIP39::toWordlist(entropy) == "letter advice cage absurd amount doctor acoustic avoid letter advice cage above");
        QVERIFY(s.toHex().toStdString() == "d71de856f81a8acc65e6fc851a38d4d7ec216fd0796d0a6827a3ad6ed5511a30fa280f12eb2e47ed2ac03b5c462a0358d18d69fe4f985ec81778c1b370b652a8");
    }
}
