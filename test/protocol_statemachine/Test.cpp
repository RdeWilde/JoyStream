...
TEST(statemachineTest, selling)
{
    ...
    f.joinedContract = event::Joined(Coin::KeyPair(Coin::PrivateKey(uchar_vector("b8aa30d8f1d398883f0eeb5079777c42"))), Coin::RedeemScriptHash::fromRawHash(uchar_vector("31149292f8ba11da4aeb833f6cd8ae0650a82340")));
...
TEST(statemachineTest, buying)
{
    ...
    f.contractPrepared = event::ContractPrepared(Coin::typesafeOutPoint(Coin::TransactionId::fromRPCByteOrder(std::string("eee2b334dd735dac60ae57893c2528087fd3d386b57cac42f4e6ace6403f16b3")), 78),
                                                 Coin::KeyPair(Coin::PrivateKey(uchar_vector("153213303DA61F20BD67FC233AA33262"))),
